...
import net.mcreator.mm.item.inventory.BackpackTier1InventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class BackpackTier1Item extends Item implements ICurioItem {
	public BackpackTier1Item() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Small Backpack");
				}
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new BackpackTier1InventoryCapability();
	}
