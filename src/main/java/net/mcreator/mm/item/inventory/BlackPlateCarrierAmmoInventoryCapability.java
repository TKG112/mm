...
public class BlackPlateCarrierAmmoInventoryCapability implements ICapabilitySerializable<CompoundTag> {
	@SubscribeEvent
	@OnlyIn(Dist.CLIENT)
	...
	private ItemStackHandler createItemHandler() {
		return new ItemStackHandler(4) {
			...
			public boolean isItemValid(int slot, @Nonnull ItemStack stack) {
				return stack.getItem() != MmModItems.BLACK_PLATE_CARRIER_AMMO.get();
			}
