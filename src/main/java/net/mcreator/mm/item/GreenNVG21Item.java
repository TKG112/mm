...
public class GreenNVG21Item extends Item implements GeoItem, ICurioItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public String animationprocedure = "empty";

	// Animations
	private static final RawAnimation ANIM_IDLE = RawAnimation.begin().thenLoop("animation.green_nvg21.idle");
	private static final RawAnimation ANIM_OPEN = RawAnimation.begin().thenPlayAndHold("animation.green_nvg21.opening").thenLoop("animation.green_nvg21.opened");
	private static final RawAnimation ANIM_CLOSE = RawAnimation.begin().thenPlayAndHold("animation.green_nvg21.closing").thenLoop("animation.green_nvg21.closed");
		...
		consumer.accept(new IClientItemExtensions() {
			...
			public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
				if (this.renderer == null)
					this.renderer = new GreenNVG21Renderer();
