...
import net.mcreator.mm.item.inventory.TanPlateCarrierPouchesInventoryCapability;
...
public class TanPlateCarrierPouchesItem extends Item implements ICurioItem, GeoAnimatable {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Tan Plate Carrier Pouches");
				}
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new TanPlateCarrierPouchesInventoryCapability();
	}
