...
public class BandoleerGUIScreen extends AbstractContainerScreen<BandoleerGUIMenu> {
	private final static HashMap<String, Object> guistate = BandoleerGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public BandoleerGUIScreen(BandoleerGUIMenu container, Inventory inventory, Component text) {
