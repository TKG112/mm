...
public class ReconGUIScreen extends AbstractContainerScreen<ReconGUIMenu> {
	private final static HashMap<String, Object> guistate = ReconGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ReconGUIScreen(ReconGUIMenu container, Inventory inventory, Component text) {
