...
import net.mcreator.mm.item.model.GreenKevlarBodyModel;
import net.mcreator.mm.item.GreenKevlarBodyItem;

public class GreenKevlarBodyArmorRenderer extends GeoArmorRenderer<GreenKevlarBodyItem> {
	public GreenKevlarBodyArmorRenderer() {
		super(new GreenKevlarBodyModel());
	...
	@Override
	public RenderType getRenderType(GreenKevlarBodyItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
