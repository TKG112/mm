...
import net.mcreator.mm.item.model.BlackMilitaryHelmetModel;
import net.mcreator.mm.item.BlackMilitaryHelmetItem;

public class BlackMilitaryHelmetArmorRenderer extends GeoArmorRenderer<BlackMilitaryHelmetItem> {
	public BlackMilitaryHelmetArmorRenderer() {
		super(new BlackMilitaryHelmetModel());
	...
	@Override
	public RenderType getRenderType(BlackMilitaryHelmetItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
