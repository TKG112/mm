...
import net.mcreator.mm.item.model.BlackVisorModel;
import net.mcreator.mm.item.BlackVisorItem;

import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.blaze3d.vertex.PoseStack;

public class BlackVisorRenderer extends GeoArmorRenderer<BlackVisorItem> implements ICurioRenderer {
	public BlackVisorRenderer() {
		super(new BlackVisorModel());
	...
	public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
		...
		VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((BlackVisorItem) stack.getItem())));
