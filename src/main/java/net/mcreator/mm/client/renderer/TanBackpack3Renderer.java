...
public class TanBackpack3Renderer implements ICurioRenderer {
	...
	public TanBackpack3Renderer() {
		this.model = new Modelplaceholder(Minecraft.getInstance().getEntityModels().bakeLayer(MmModLayerDefinitions.TAN_BACKPACK_3));
	}
