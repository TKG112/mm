...
public class TanPlateCarrierRenderer implements ICurioRenderer {
	...
	public TanPlateCarrierRenderer() {
		this.model = new Modelplaceholder(Minecraft.getInstance().getEntityModels().bakeLayer(MmModLayerDefinitions.TAN_PLATE_CARRIER));
	}
