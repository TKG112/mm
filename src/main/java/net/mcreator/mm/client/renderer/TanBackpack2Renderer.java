...
public class TanBackpack2Renderer implements ICurioRenderer {
	...
	public TanBackpack2Renderer() {
		this.model = new Modelplaceholder(Minecraft.getInstance().getEntityModels().bakeLayer(MmModLayerDefinitions.TAN_BACKPACK_2));
	}
