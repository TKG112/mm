...
import net.mcreator.mm.item.model.GreenKevlarBootsModel;
import net.mcreator.mm.item.GreenKevlarBootsItem;

public class GreenKevlarBootsArmorRenderer extends GeoArmorRenderer<GreenKevlarBootsItem> {
	public GreenKevlarBootsArmorRenderer() {
		super(new GreenKevlarBootsModel());
	...
	@Override
	public RenderType getRenderType(GreenKevlarBootsItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
