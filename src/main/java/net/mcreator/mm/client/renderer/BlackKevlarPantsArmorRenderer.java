...
import net.mcreator.mm.item.model.BlackKevlarPantsModel;
import net.mcreator.mm.item.BlackKevlarPantsItem;

public class BlackKevlarPantsArmorRenderer extends GeoArmorRenderer<BlackKevlarPantsItem> {
	public BlackKevlarPantsArmorRenderer() {
		super(new BlackKevlarPantsModel());
	...
	@Override
	public RenderType getRenderType(BlackKevlarPantsItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
