...
import net.mcreator.mm.item.model.MilitaryBalaclavaModel;
import net.mcreator.mm.item.MilitaryBalaclavaItem;

import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.blaze3d.vertex.PoseStack;

public class MilitaryBalaclavaRenderer extends GeoArmorRenderer<MilitaryBalaclavaItem> implements ICurioRenderer {
	public MilitaryBalaclavaRenderer() {
		super(new MilitaryBalaclavaModel());
	...
	public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
		...
		VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((MilitaryBalaclavaItem) stack.getItem())));
