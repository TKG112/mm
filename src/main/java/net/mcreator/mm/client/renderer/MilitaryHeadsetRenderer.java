...
import net.mcreator.mm.item.model.MilitaryHeadsetModel;
import net.mcreator.mm.item.MilitaryHeadsetItem;

import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.blaze3d.vertex.PoseStack;

public class MilitaryHeadsetRenderer extends GeoArmorRenderer<MilitaryHeadsetItem> implements ICurioRenderer {
	public MilitaryHeadsetRenderer() {
		super(new MilitaryHeadsetModel());
	...
	public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
		...
		VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((MilitaryHeadsetItem) stack.getItem())));
