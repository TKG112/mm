...
public class TanPlateCarrierAmmoRenderer implements ICurioRenderer {
	...
	public TanPlateCarrierAmmoRenderer() {
		this.model = new Modelplaceholder(Minecraft.getInstance().getEntityModels().bakeLayer(MmModLayerDefinitions.TAN_PLATE_CARRIER_AMMO));
	}
