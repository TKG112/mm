...
import net.mcreator.mm.item.model.BlackIOLAModel;
import net.mcreator.mm.item.BlackIOLAItem;

public class BlackIOLAArmorRenderer extends GeoArmorRenderer<BlackIOLAItem> {
	public BlackIOLAArmorRenderer() {
		super(new BlackIOLAModel());
	...
	@Override
	public RenderType getRenderType(BlackIOLAItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
