...
import net.mcreator.mm.item.model.NVGModel;
...
public class NVGRenderer extends GeoArmorRenderer<NVGItem> implements ICurioRenderer{
	...
	public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
		...
		VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((NVGItem) stack.getItem())));
