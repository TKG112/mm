...
import net.mcreator.mm.item.model.BlackCombatHelmetModel;
import net.mcreator.mm.item.BlackCombatHelmetItem;

public class BlackCombatHelmetArmorRenderer extends GeoArmorRenderer<BlackCombatHelmetItem> {
	public BlackCombatHelmetArmorRenderer() {
		super(new BlackCombatHelmetModel());
	...
	@Override
	public RenderType getRenderType(BlackCombatHelmetItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
