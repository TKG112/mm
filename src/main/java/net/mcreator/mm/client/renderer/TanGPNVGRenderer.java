...
public class TanGPNVGRenderer implements ICurioRenderer {
	...
	public TanGPNVGRenderer() {
		this.model = new Modelplaceholder(Minecraft.getInstance().getEntityModels().bakeLayer(MmModLayerDefinitions.TAN_GPNVG));
	}
