...
import net.mcreator.mm.item.model.BlackKevlarBodyModel;
import net.mcreator.mm.item.BlackKevlarBodyItem;

public class BlackKevlarBodyArmorRenderer extends GeoArmorRenderer<BlackKevlarBodyItem> {
	public BlackKevlarBodyArmorRenderer() {
		super(new BlackKevlarBodyModel());
	...
	@Override
	public RenderType getRenderType(BlackKevlarBodyItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
