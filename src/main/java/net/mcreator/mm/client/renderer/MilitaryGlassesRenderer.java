...
public class MilitaryGlassesRenderer extends GeoArmorRenderer<MilitaryGlassesItem> implements ICurioRenderer {
	public MilitaryGlassesRenderer() {
		super(new MilitaryGlassesModel());
	...
	public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
		...
		VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((MilitaryGlassesItem) stack.getItem())));
