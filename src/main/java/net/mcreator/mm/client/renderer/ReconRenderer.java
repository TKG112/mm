...
import net.mcreator.mm.item.model.ReconModel;
import net.mcreator.mm.item.ReconItem;

import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.blaze3d.vertex.PoseStack;

public class ReconRenderer extends GeoArmorRenderer<ReconItem> implements ICurioRenderer {
	public ReconRenderer() {
		super(new ReconModel());
	...
	public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
		...
		VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((ReconItem) stack.getItem())));
