...
import net.mcreator.mm.item.model.GreenIOLAModel;
import net.mcreator.mm.item.GreenIOLAItem;

public class GreenIOLAArmorRenderer extends GeoArmorRenderer<GreenIOLAItem> {
	public GreenIOLAArmorRenderer() {
		super(new GreenIOLAModel());
	...
	@Override
	public RenderType getRenderType(GreenIOLAItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
