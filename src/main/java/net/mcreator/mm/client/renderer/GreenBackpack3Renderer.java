...
public class GreenBackpack3Renderer implements ICurioRenderer {
	...
	public GreenBackpack3Renderer() {
		this.model = new Modelplaceholder(Minecraft.getInstance().getEntityModels().bakeLayer(MmModLayerDefinitions.GREEN_BACKPACK_3));
	}
