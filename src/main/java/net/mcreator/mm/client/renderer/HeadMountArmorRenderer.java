...
import net.mcreator.mm.item.model.HeadMountModel;
import net.mcreator.mm.item.HeadMountItem;

public class HeadMountArmorRenderer extends GeoArmorRenderer<HeadMountItem> {
	public HeadMountArmorRenderer() {
		super(new HeadMountModel());
	...
	@Override
	public RenderType getRenderType(HeadMountItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
