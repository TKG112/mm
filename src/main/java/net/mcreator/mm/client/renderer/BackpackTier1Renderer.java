...
public class BackpackTier1Renderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("mm", "textures/entities/texture.png");
	private final Modelplaceholder model;

	public BackpackTier1Renderer() {
		this.model = new Modelplaceholder(Minecraft.getInstance().getEntityModels().bakeLayer(MmModLayerDefinitions.BACKPACK_TIER_1));
	}
