...
import net.mcreator.mm.item.model.GreenKevlarPantsModel;
import net.mcreator.mm.item.GreenKevlarPantsItem;

public class GreenKevlarPantsArmorRenderer extends GeoArmorRenderer<GreenKevlarPantsItem> {
	public GreenKevlarPantsArmorRenderer() {
		super(new GreenKevlarPantsModel());
	...
	@Override
	public RenderType getRenderType(GreenKevlarPantsItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
