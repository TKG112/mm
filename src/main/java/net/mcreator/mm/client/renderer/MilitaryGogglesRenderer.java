...
public class MilitaryGogglesRenderer extends GeoArmorRenderer<MilitaryGogglesItem> implements ICurioRenderer {
	public MilitaryGogglesRenderer() {
		super(new MilitaryGogglesModel());
	...
	@Override
	public RenderType getRenderType(MilitaryGogglesItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
		...
		VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((MilitaryGogglesItem) stack.getItem())));
