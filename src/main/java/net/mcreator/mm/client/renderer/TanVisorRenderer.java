...
import net.mcreator.mm.item.model.TanVisorModel;
import net.mcreator.mm.item.TanVisorItem;

import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.blaze3d.vertex.PoseStack;

public class TanVisorRenderer extends GeoArmorRenderer<TanVisorItem> implements ICurioRenderer {
	public TanVisorRenderer() {
		super(new TanVisorModel());
	...
	public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
		...
		VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((TanVisorItem) stack.getItem())));
