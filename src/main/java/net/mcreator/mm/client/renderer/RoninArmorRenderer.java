...
import net.mcreator.mm.item.model.RoninModel;
import net.mcreator.mm.item.RoninItem;

public class RoninArmorRenderer extends GeoArmorRenderer<RoninItem> {
	public RoninArmorRenderer() {
		super(new RoninModel());
	...
	@Override
	public RenderType getRenderType(RoninItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
