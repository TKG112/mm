...
public class TanPlateCarrierPouchesRenderer implements ICurioRenderer {
	...
	public TanPlateCarrierPouchesRenderer() {
		this.model = new Modelplaceholder(Minecraft.getInstance().getEntityModels().bakeLayer(MmModLayerDefinitions.TAN_PLATE_CARRIER_POUCHES));
	}
