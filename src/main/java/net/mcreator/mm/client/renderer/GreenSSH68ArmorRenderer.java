...
import net.mcreator.mm.item.model.GreenSSH68Model;
import net.mcreator.mm.item.GreenSSH68Item;

public class GreenSSH68ArmorRenderer extends GeoArmorRenderer<GreenSSH68Item> {
	public GreenSSH68ArmorRenderer() {
		super(new GreenSSH68Model());
	...
	@Override
	public RenderType getRenderType(GreenSSH68Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
