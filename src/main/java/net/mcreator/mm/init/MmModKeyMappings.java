...
public class MmModKeyMappings {
	public static final KeyMapping TOGGLE_NVG = new KeyMapping("key.mm.toggle_nvg", GLFW.GLFW_KEY_N, "key.categories.misc") {
	...
	public static final KeyMapping INCREASE_TUBE_GAIN = new KeyMapping("key.mm.increase_tube_gain", GLFW.GLFW_KEY_UP, "key.categories.misc") {
		private boolean isDownOld = false;
	...
	public static final KeyMapping DECREASE_TUBE_GAIN = new KeyMapping("key.mm.decrease_tube_gain", GLFW.GLFW_KEY_DOWN, "key.categories.misc") {
		private boolean isDownOld = false;
