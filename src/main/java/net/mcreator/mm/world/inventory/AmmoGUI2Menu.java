...
import net.mcreator.mm.procedures.AmmoGUI2ThisGUIIsClosedProcedure;
...
public class AmmoGUI2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AmmoGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MmModMenus.AMMO_GUI_2.get(), id);
	...
	public void removed(Player playerIn) {
		...
		AmmoGUI2ThisGUIIsClosedProcedure.execute(world, entity);
