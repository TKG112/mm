...
public class AmmoGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AmmoGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MmModMenus.AMMO_GUI.get(), id);
