...
public class BandoleerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BandoleerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MmModMenus.BANDOLEER_GUI.get(), id);
