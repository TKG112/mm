...
import net.mcreator.mm.procedures.Tier1BackpackGUI2ThisGUIIsClosedProcedure;
...
public class Tier1BackpackGUI2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Tier1BackpackGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MmModMenus.TIER_1_BACKPACK_GUI_2.get(), id);
	...
	public void removed(Player playerIn) {
		...
		Tier1BackpackGUI2ThisGUIIsClosedProcedure.execute(world, entity);
