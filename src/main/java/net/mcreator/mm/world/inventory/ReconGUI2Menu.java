...
import net.mcreator.mm.procedures.ReconGUI2ThisGUIIsClosedProcedure;
...
public class ReconGUI2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ReconGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MmModMenus.RECON_GUI_2.get(), id);
	...
	public void removed(Player playerIn) {
		...
		ReconGUI2ThisGUIIsClosedProcedure.execute(world, entity);
