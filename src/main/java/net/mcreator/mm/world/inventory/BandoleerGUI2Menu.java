...
import net.mcreator.mm.procedures.BandoleerGUI2ThisGUIIsClosedProcedure;
...
public class BandoleerGUI2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BandoleerGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MmModMenus.BANDOLEER_GUI_2.get(), id);
	...
	public void removed(Player playerIn) {
		...
		BandoleerGUI2ThisGUIIsClosedProcedure.execute(world, entity);
