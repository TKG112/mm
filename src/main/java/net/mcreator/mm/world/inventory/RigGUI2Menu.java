...
import net.mcreator.mm.procedures.RigGUI2ThisGUIIsClosedProcedure;
...
public class RigGUI2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RigGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MmModMenus.RIG_GUI_2.get(), id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 53, 41) {
			private final int slot = 4;
		}));
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 71, 41) {
			private final int slot = 5;
		}));
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 89, 41) {
			private final int slot = 6;
		}));
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 107, 41) {
	...
	public void removed(Player playerIn) {
		...
		RigGUI2ThisGUIIsClosedProcedure.execute(world, entity);
