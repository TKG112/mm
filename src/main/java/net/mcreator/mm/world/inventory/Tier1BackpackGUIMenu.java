...
public class Tier1BackpackGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Tier1BackpackGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MmModMenus.TIER_1_BACKPACK_GUI.get(), id);
