...
public class ServerConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> OVERRIDE_CLIENT_CONFIG_OPTIONS;
    ...
    static {
        ...
        OVERRIDE_CLIENT_CONFIG_OPTIONS = BUILDER
                .comment("If the server config should override the client config options")
                .define("overrideClientConfig", false);
        BUILDER.pop();
