...
public class SoundRegistryMM {
    ...
    public static RegistryObject<SoundEvent> SOUND_VISOR_OPEN = registerSoundsEvent("sound_visor_open");
    public static RegistryObject<SoundEvent> SOUND_VISOR_CLOSE = registerSoundsEvent("sound_visor_close");
