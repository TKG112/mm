...
public class NVGConfigs {
    ...
    public static GenericSpecialGogglesItem.NVGConfig[] WHITE_PHOSPHOR_GPVNG = {
            new GenericSpecialGogglesItem.NVGConfig(
                    0.35f,
                    0.25f,
                    0.5f,
                    0.5f,
    ...
    public static GenericSpecialGogglesItem.NVGConfig[] GREEN_PHOSPHOR_GPVNG = {
            new GenericSpecialGogglesItem.NVGConfig(
                    0.4f,
                    0.2f,
                    0.5f,
    ...
    public static GenericSpecialGogglesItem.NVGConfig[] WHITE_PHOSPHOR_PVS14 = {
            new GenericSpecialGogglesItem.NVGConfig(
                    0.4f,
                    0.25f,
                    0.5f,
    ...
    public static GenericSpecialGogglesItem.NVGConfig[] GREEN_PHOSPHOR_PVS14 = {
            new GenericSpecialGogglesItem.NVGConfig(
                    0.45f,
                    0.2f,
                    0.5f,
    ...
    public static GenericSpecialGogglesItem.NVGConfig[] WHITE_PHOSPHOR_PVS7 = {
            new GenericSpecialGogglesItem.NVGConfig(
                    0.4f,
                    0.25f,
                    0.5f,
    ...
    public static GenericSpecialGogglesItem.NVGConfig[] GREEN_PHOSPHOR_PVS7 = {
            new GenericSpecialGogglesItem.NVGConfig(
                    0.45f,
                    0.2f,
                    0.5f,
            ...
            new GenericSpecialGogglesItem.NVGConfig(
                    0.55f, 0.2f, 0.5f, 0.2f,
                    "textures/screens/pvs7_overlay.png",
                    2.0f
            )
    };

    public static GenericSpecialGogglesItem.NVGConfig[] THERMAL = {
            new GenericSpecialGogglesItem.NVGConfig(
                    "textures/screens/pvs7_overlay.png"
            )
    };
