...
public class NVGAutoGainTogglePacket extends PacketBase {

    public NVGAutoGainTogglePacket() {}

    public NVGAutoGainTogglePacket(FriendlyByteBuf buffer) {}
        ...
        context.enqueueWork(() -> {
            ...
            if (player != null) {
                if (CuriosUtil.hasNVGEquipped(player)) {
                    ...
                    if (facewearItem.getItem() instanceof GenericSpecialGogglesItem nvgGogglesItem) {
