...
import net.tkg.ModernMayhem.client.renderer.BlackBackpackT2Renderer;
...
public class BlackBackpackT2Item extends GenericBackpackItem implements GeoItem, ICurioItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public BlackBackpackT2Item() {
        super(3, 6);
    }
        ...
        pPlayer.openMenu(new MenuProvider() {
            ...
            public @Nullable AbstractContainerMenu createMenu(int pContainerId, Inventory pPlayerInventory, Player pPlayer) {
                ...
                if (!tag.contains("inventory")) {
                    ...
                    System.out.println("Did not find inventory when opening the backpack gui");
                }
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.lRenderer == null)
                    this.lRenderer = new BlackBackpackT2Renderer();
