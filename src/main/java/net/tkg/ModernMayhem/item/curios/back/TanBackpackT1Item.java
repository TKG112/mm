    ...
    public void OpenGUIFromPlayerInventory(Player pPlayer, ItemStack pStack) {
        pPlayer.openMenu(new MenuProvider() {
            ...
            public @Nullable AbstractContainerMenu createMenu(int pContainerId, Inventory pPlayerInventory, Player pPlayer) {
                ...
                return new BackpackT1GUIMenu(pContainerId, pPlayerInventory, data);
            }
        });
    }
        ...
        pPlayer.openMenu(new MenuProvider() {
            ...
            public @Nullable AbstractContainerMenu createMenu(int pContainerId, Inventory pPlayerInventory, Player pPlayer) {
                ...
                if (!tag.contains("inventory")) {
                    ...
                    System.out.println("No inventory found when opening the backpack gui");
                }
                InitInventory(pStack, 3*3);
                data.writeNbt(tag.getCompound("inventory"));
                data.writeBoolean(true);
                data.writeItemStack(pStack, false);
                int backpackSlotID = CuriosUtil.getBackpackSlotID(pPlayer);
                System.out.println("Backpack slot ID: " + backpackSlotID);
                ...
                return new BackpackT1GUIMenu(pContainerId, pPlayerInventory, playerCuriosInventory, data);
            }
        });
    }
