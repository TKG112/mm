...
public class BlackBackpackT2Renderer extends GeoArmorRenderer<BlackBackpackT2Item> implements ICurioRenderer {
    public BlackBackpackT2Renderer()  { super(new BlackBackpackT2Model()); }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((BlackBackpackT2Item) stack.getItem())));
