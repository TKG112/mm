...
import net.tkg.ModernMayhem.client.models.TanBackpackT2Model;
import net.tkg.ModernMayhem.item.curios.back.TanBackpackT2Item;
import software.bernie.geckolib.renderer.GeoArmorRenderer;
import top.theillusivec4.curios.api.SlotContext;
import top.theillusivec4.curios.api.client.ICurioRenderer;

public class TanBackpackT2Renderer extends GeoArmorRenderer<TanBackpackT2Item> implements ICurioRenderer {
    public TanBackpackT2Renderer()  { super(new TanBackpackT2Model()); }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((TanBackpackT2Item) stack.getItem())));
