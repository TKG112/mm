package net.tkg.ModernMayhem.client.renderer.curios.head;
...
public class HeadGearRenderer extends GeoArmorRenderer<HeadGearItems> implements ICurioRenderer {
    public HeadGearRenderer() {
        super(new HeadGearModel());
    }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((HeadGearItems) stack.getItem())));
