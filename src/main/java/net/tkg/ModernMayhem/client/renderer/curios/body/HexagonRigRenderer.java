...
public class HexagonRigRenderer extends GeoArmorRenderer<HexagonRigItem> implements ICurioRenderer {
    public HexagonRigRenderer()  { super(new HexagonRigModel()); }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((HexagonRigItem) stack.getItem())));
    ...
    public static class HexagonRigSlotRenderer extends GeoItemRenderer<HexagonRigItem> {
        public HexagonRigSlotRenderer()  { super(new HexagonRigModel()); }
    }
}
