...
import net.tkg.ModernMayhem.client.models.GreenReconRigModel;
import net.tkg.ModernMayhem.item.curios.body.GreenReconRigItem;
import software.bernie.geckolib.renderer.GeoArmorRenderer;
import top.theillusivec4.curios.api.SlotContext;
import top.theillusivec4.curios.api.client.ICurioRenderer;

public class GreenReconRigRenderer extends GeoArmorRenderer<GreenReconRigItem> implements ICurioRenderer {
    public GreenReconRigRenderer() { super(new GreenReconRigModel()); }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((GreenReconRigItem) stack.getItem())));
