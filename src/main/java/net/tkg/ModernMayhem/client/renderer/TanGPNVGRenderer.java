...
import net.tkg.ModernMayhem.client.models.TanGPNVGModel;
import net.tkg.ModernMayhem.item.curios.facewear.BlackGPNVGItem;
...
public class TanGPNVGRenderer extends GeoArmorRenderer<TanGPNVGItem> implements ICurioRenderer {
    public TanGPNVGRenderer() {
        super(new TanGPNVGModel());
    }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((TanGPNVGItem) stack.getItem())));
