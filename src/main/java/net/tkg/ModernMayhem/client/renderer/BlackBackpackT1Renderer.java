...
public class BlackBackpackT1Renderer extends GeoArmorRenderer<BlackBackpackT1Item> implements ICurioRenderer {
    public BlackBackpackT1Renderer()  { super(new BlackBackpackT1Model()); }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((BlackBackpackT1Item) stack.getItem())));
