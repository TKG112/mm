...
import net.tkg.ModernMayhem.client.models.TanBackpackT3Model;
import net.tkg.ModernMayhem.item.curios.back.TanBackpackT3Item;
import software.bernie.geckolib.renderer.GeoArmorRenderer;
import top.theillusivec4.curios.api.SlotContext;
import top.theillusivec4.curios.api.client.ICurioRenderer;

public class TanBackpackT3Renderer extends GeoArmorRenderer<TanBackpackT3Item> implements ICurioRenderer {
    public TanBackpackT3Renderer()  { super(new TanBackpackT3Model()); }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((TanBackpackT3Item) stack.getItem())));
