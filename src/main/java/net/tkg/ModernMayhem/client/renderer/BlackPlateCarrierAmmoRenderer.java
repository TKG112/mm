...
public class BlackPlateCarrierAmmoRenderer extends GeoArmorRenderer<BlackPlateCarrierAmmoItem> implements ICurioRenderer {
    public BlackPlateCarrierAmmoRenderer() { super(new BlackPlateCarrierAmmoModel()); }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((BlackPlateCarrierAmmoItem) stack.getItem())));
