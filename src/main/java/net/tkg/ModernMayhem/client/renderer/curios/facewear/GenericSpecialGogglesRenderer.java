...
public class GenericSpecialGogglesRenderer<T extends GenericSpecialGogglesItem> extends GeoArmorRenderer<T> implements ICurioRenderer {
    ...
    public ResourceLocation getTextureLocation(T animatable) {
        if (!this.currentRenderStack.isEmpty() && this.model instanceof GenericSpecialGogglesModel) {
            GenericSpecialGogglesModel<T> geoModel = (GenericSpecialGogglesModel<T>) this.model;
