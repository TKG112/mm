...
import net.tkg.ModernMayhem.client.models.TanBandoleerModel;
import net.tkg.ModernMayhem.item.curios.body.TanBandoleerItem;
import software.bernie.geckolib.renderer.GeoArmorRenderer;
import top.theillusivec4.curios.api.SlotContext;
import top.theillusivec4.curios.api.client.ICurioRenderer;

public class TanBandoleerRenderer extends GeoArmorRenderer<TanBandoleerItem> implements ICurioRenderer {
    public TanBandoleerRenderer()  { super(new TanBandoleerModel()); }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((TanBandoleerItem) stack.getItem())));
