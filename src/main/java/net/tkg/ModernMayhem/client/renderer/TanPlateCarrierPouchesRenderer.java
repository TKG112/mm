...
import net.tkg.ModernMayhem.client.models.TanPlateCarrierPouchesModel;
...
public class TanPlateCarrierPouchesRenderer extends GeoArmorRenderer<TanPlateCarrierPouchesItem> implements ICurioRenderer {
    public TanPlateCarrierPouchesRenderer() { super(new TanPlateCarrierPouchesModel()); }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull(this.getTextureLocation((TanPlateCarrierPouchesItem) stack.getItem())));
