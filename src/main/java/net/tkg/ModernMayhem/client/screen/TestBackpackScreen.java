...
public class TestBackpackScreen extends AbstractContainerScreen<TestBackpackGUIMenu> implements GenericBackpackScreen{
    public TestBackpackScreen(TestBackpackGUIMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
