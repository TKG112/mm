...
public class BackpackModels extends GeoModel<BackpackItem> {
    ...
    public ResourceLocation getModelResource(BackpackItem animatable) {
        return switch (animatable.getTier()-1) {
            case 0 -> fromNamespaceAndPath(ModernMayhemMod.ID, "geo/item/curios/back/backpack_t1.geo.json");
            case 1 -> fromNamespaceAndPath(ModernMayhemMod.ID, "geo/item/curios/back/backpack_t2.geo.json");
            case 2 -> fromNamespaceAndPath(ModernMayhemMod.ID, "geo/item/curios/back/backpack_t3.geo.json");
    ...
    public ResourceLocation getTextureResource(BackpackItem animatable) {
        return switch (animatable.getVariant()) {
            case 0 -> fromNamespaceAndPath(ModernMayhemMod.ID, "textures/item/curios/back/black_backpack.png");
            case 1 -> fromNamespaceAndPath(ModernMayhemMod.ID, "textures/item/curios/back/green_backpack.png");
            case 2 -> fromNamespaceAndPath(ModernMayhemMod.ID, "textures/item/curios/back/tan_backpack.png");
